...
namespace SDK.Script.EnhancedInputSDK
{
    ...
    public class EnhancedInputDeveloperSettings : DeveloperSettingsBackedByCVars
    {
        ...
        public Array<DefaultContextSetting> DefaultMappingContexts { get { return new Array<DefaultContextSetting>(this[nameof(DefaultMappingContexts)].Address); } }
        public Array<DefaultContextSetting> DefaultWorldSubsystemMappingContexts { get { return new Array<DefaultContextSetting>(this[nameof(DefaultWorldSubsystemMappingContexts)].Address); } }
        public Object DefaultWorldInputClass { get { return this[nameof(DefaultWorldInputClass)]; } set { this[nameof(DefaultWorldInputClass)] = value; } }
        ...
        public bool bEnableDefaultMappingContexts { get { return this[nameof(bEnableDefaultMappingContexts)].Flag; } set { this[nameof(bEnableDefaultMappingContexts)].Flag = value; } }
        ...
        public bool bEnableWorldSubsystem { get { return this[nameof(bEnableWorldSubsystem)].Flag; } set { this[nameof(bEnableWorldSubsystem)].Flag = value; } }
        public bool bShouldLogAllWorldSubsystemInputs { get { return this[nameof(bShouldLogAllWorldSubsystemInputs)].Flag; } set { this[nameof(bShouldLogAllWorldSubsystemInputs)].Flag = value; } }
    }
    public class EnhancedInputLibrary : BlueprintFunctionLibrary
    {
        ...
        public bool IsActionKeyMappingPlayerMappable(EnhancedActionKeyMapping ActionKeyMapping) { return Invoke<bool>(nameof(IsActionKeyMappingPlayerMappable), ActionKeyMapping); }
        public PlayerMappableKeySlot GetThirdPlayerMappableKeySlot() { return Invoke<PlayerMappableKeySlot>(nameof(GetThirdPlayerMappableKeySlot)); }
        public PlayerMappableKeySlot GetSecondPlayerMappableKeySlot() { return Invoke<PlayerMappableKeySlot>(nameof(GetSecondPlayerMappableKeySlot)); }
        public PlayerMappableKeySettings GetPlayerMappableKeySettings(EnhancedActionKeyMapping ActionKeyMapping) { return Invoke<PlayerMappableKeySettings>(nameof(GetPlayerMappableKeySettings), ActionKeyMapping); }
        public Object GetMappingName(EnhancedActionKeyMapping ActionKeyMapping) { return Invoke<Object>(nameof(GetMappingName), ActionKeyMapping); }
        public PlayerMappableKeySlot GetFourthPlayerMappableKeySlot() { return Invoke<PlayerMappableKeySlot>(nameof(GetFourthPlayerMappableKeySlot)); }
        public PlayerMappableKeySlot GetFirstPlayerMappableKeySlot() { return Invoke<PlayerMappableKeySlot>(nameof(GetFirstPlayerMappableKeySlot)); }
    ...
    public class EnhancedInputSubsystemInterface : Interface
    {
        ...
        public int RemoveAllPlayerMappedKeysForMapping(Object MappingName, ModifyContextOptions Options) { return Invoke<int>(nameof(RemoveAllPlayerMappedKeysForMapping), MappingName, Options); }
        ...
        public int K2_RemovePlayerMappedKeyInSlot(Object MappingName, PlayerMappableKeySlot KeySlot, ModifyContextOptions Options) { return Invoke<int>(nameof(K2_RemovePlayerMappedKeyInSlot), MappingName, KeySlot, Options); }
        public Key K2_GetPlayerMappedKeyInSlot(Object MappingName, PlayerMappableKeySlot KeySlot) { return Invoke<Key>(nameof(K2_GetPlayerMappedKeyInSlot), MappingName, KeySlot); }
        public int K2_AddPlayerMappedKeyInSlot(Object MappingName, Key NewKey, PlayerMappableKeySlot KeySlot, ModifyContextOptions Options) { return Invoke<int>(nameof(K2_AddPlayerMappedKeyInSlot), MappingName, NewKey, KeySlot, Options); }
        ...
        public Array<Key> GetAllPlayerMappedKeys(Object MappingName) { return Invoke<Array<Key>>(nameof(GetAllPlayerMappedKeys), MappingName); }
    ...
    public class EnhancedInputWorldSubsystem : WorldSubsystem
    {
        public EnhancedInputWorldSubsystem(nint addr) : base(addr) { }
        public EnhancedPlayerInput PlayerInput { get { return this[nameof(PlayerInput)].As<EnhancedPlayerInput>(); } set { this["PlayerInput"] = value; } }
        public Array<Object> CurrentInputStack { get { return new Array<Object>(this[nameof(CurrentInputStack)].Address); } }
        public bool RemoveActorInputComponent(Actor Actor) { return Invoke<bool>(nameof(RemoveActorInputComponent), Actor); }
        public void AddActorInputComponent(Actor Actor) { Invoke(nameof(AddActorInputComponent), Actor); }
    }
    ...
    public class InputAction : DataAsset
    {
        ...
        public PlayerMappableKeySettings PlayerMappableKeySettings { get { return this[nameof(PlayerMappableKeySettings)].As<PlayerMappableKeySettings>(); } set { this["PlayerMappableKeySettings"] = value; } }
    }
    ...
    public class InputTriggerCombo : InputTrigger
    {
        ...
        public Array<InputCancelAction> InputCancelActions { get { return new Array<InputCancelAction>(this[nameof(InputCancelActions)].Address); } }
    }
    ...
    public class PlayerMappableKeySettings : Object
    {
        public PlayerMappableKeySettings(nint addr) : base(addr) { }
        public Object MetaData { get { return this[nameof(MetaData)].As<Object>(); } set { this["MetaData"] = value; } }
    ...
    public enum EPlayerMappableKeySettingBehaviors : int
    {
    ...
    public class PlayerMappableKeySlot : Object
    {
        public PlayerMappableKeySlot(nint addr) : base(addr) { }
        public int SlotNumber { get { return this[nameof(SlotNumber)].GetValue<int>(); } set { this[nameof(SlotNumber)].SetValue<int>(value); } }
    }
    ...
    public class EnhancedActionKeyMapping : Object
    {
        ...
        public EPlayerMappableKeySettingBehaviors SettingBehavior { get { return (EPlayerMappableKeySettingBehaviors)this[nameof(SettingBehavior)].GetValue<int>(); } set { this[nameof(SettingBehavior)].SetValue<int>((int)value); } }
        public PlayerMappableKeySettings PlayerMappableKeySettings { get { return this[nameof(PlayerMappableKeySettings)].As<PlayerMappableKeySettings>(); } set { this["PlayerMappableKeySettings"] = value; } }
    ...
    public class DefaultContextSetting : Object
    {
        public DefaultContextSetting(nint addr) : base(addr) { }
        public Object InputMappingContext { get { return this[nameof(InputMappingContext)]; } set { this[nameof(InputMappingContext)] = value; } }
    ...
    public class InputComboStepData : Object
    {
        ...
        public byte ComboStepCompletionStates { get { return this[nameof(ComboStepCompletionStates)].GetValue<byte>(); } set { this[nameof(ComboStepCompletionStates)].SetValue<byte>(value); } }
    ...
    public class InputCancelAction : Object
    {
        public InputCancelAction(nint addr) : base(addr) { }
        public InputAction CancelAction { get { return this[nameof(CancelAction)].As<InputAction>(); } set { this["CancelAction"] = value; } }
        public byte CancellationStates { get { return this[nameof(CancellationStates)].GetValue<byte>(); } set { this[nameof(CancellationStates)].SetValue<byte>(value); } }
    }
}
