...
{
    public class NDIRenderTargetVolumeSimCacheData : Object
    {
        public NDIRenderTargetVolumeSimCacheData(nint addr) : base(addr) { }
        public Object CompressionType { get { return this[nameof(CompressionType)]; } set { this[nameof(CompressionType)] = value; } }
        public Array<NDIRenderTargetVolumeSimCacheFrame> Frames { get { return new Array<NDIRenderTargetVolumeSimCacheFrame>(this[nameof(Frames)].Address); } }
    }
    public class NiagaraConvertInPlaceUtilityBase : Object
    {
        public NiagaraConvertInPlaceUtilityBase(nint addr) : base(addr) { }
    }
    public class NiagaraDataChannelReader : Object
    {
        public NiagaraDataChannelReader(nint addr) : base(addr) { }
        public NiagaraDataChannelHandler Owner { get { return this[nameof(Owner)].As<NiagaraDataChannelHandler>(); } set { this["Owner"] = value; } }
        public Vector4 ReadVector4(Object VarName, int Index) { return Invoke<Vector4>(nameof(ReadVector4), VarName, Index); }
        public Vector2D ReadVector2D(Object VarName, int Index) { return Invoke<Vector2D>(nameof(ReadVector2D), VarName, Index); }
        public Vector ReadVector(Object VarName, int Index) { return Invoke<Vector>(nameof(ReadVector), VarName, Index); }
        public Quat ReadQuat(Object VarName, int Index) { return Invoke<Quat>(nameof(ReadQuat), VarName, Index); }
        public LinearColor ReadLinearColor(Object VarName, int Index) { return Invoke<LinearColor>(nameof(ReadLinearColor), VarName, Index); }
        public int ReadInt(Object VarName, int Index) { return Invoke<int>(nameof(ReadInt), VarName, Index); }
        public double ReadFloat(Object VarName, int Index) { return Invoke<double>(nameof(ReadFloat), VarName, Index); }
        public bool ReadBool(Object VarName, int Index) { return Invoke<bool>(nameof(ReadBool), VarName, Index); }
        public int Num() { return Invoke<int>(nameof(Num)); }
        public bool InitAccess(ActorComponent OwningComponent) { return Invoke<bool>(nameof(InitAccess), OwningComponent); }
    }
    public class NiagaraDataChannelWriter : Object
    {
        public NiagaraDataChannelWriter(nint addr) : base(addr) { }
        public NiagaraDataChannelHandler Owner { get { return this[nameof(Owner)].As<NiagaraDataChannelHandler>(); } set { this["Owner"] = value; } }
        public void WriteVector4(Object VarName, int Index, Vector4 InData) { Invoke(nameof(WriteVector4), VarName, Index, InData); }
        public void WriteVector2D(Object VarName, int Index, Vector2D InData) { Invoke(nameof(WriteVector2D), VarName, Index, InData); }
        public void WriteVector(Object VarName, int Index, Vector InData) { Invoke(nameof(WriteVector), VarName, Index, InData); }
        public void WriteSpawnInfo(Object VarName, int Index, NiagaraSpawnInfo InData) { Invoke(nameof(WriteSpawnInfo), VarName, Index, InData); }
        public void WriteQuat(Object VarName, int Index, Quat InData) { Invoke(nameof(WriteQuat), VarName, Index, InData); }
        public void WriteLinearColor(Object VarName, int Index, LinearColor InData) { Invoke(nameof(WriteLinearColor), VarName, Index, InData); }
        public void WriteInt(Object VarName, int Index, int InData) { Invoke(nameof(WriteInt), VarName, Index, InData); }
        public void WriteFloat(Object VarName, int Index, double InData) { Invoke(nameof(WriteFloat), VarName, Index, InData); }
        public void WriteBool(Object VarName, int Index, bool InData) { Invoke(nameof(WriteBool), VarName, Index, InData); }
        public int Num() { return Invoke<int>(nameof(Num)); }
        public bool InitWrite(ActorComponent OwningComponent, int Count, bool bVisibleToGame, bool bVisibleToCPU, bool bVisibleToGPU) { return Invoke<bool>(nameof(InitWrite), OwningComponent, Count, bVisibleToGame, bVisibleToCPU, bVisibleToGPU); }
    }
    public class NiagaraDataChannelDefinitions : Object
    {
        public NiagaraDataChannelDefinitions(nint addr) : base(addr) { }
        public Array<NiagaraDataChannel> DataChannels { get { return new Array<NiagaraDataChannel>(this[nameof(DataChannels)].Address); } }
    }
    public class NiagaraDataChannelHandler : Object
    {
        public NiagaraDataChannelHandler(nint addr) : base(addr) { }
        public NiagaraDataChannel DataChannel { get { return this[nameof(DataChannel)].As<NiagaraDataChannel>(); } set { this["DataChannel"] = value; } }
        public NiagaraDataChannelWriter Writer { get { return this[nameof(Writer)].As<NiagaraDataChannelWriter>(); } set { this["Writer"] = value; } }
        public NiagaraDataChannelReader Reader { get { return this[nameof(Reader)].As<NiagaraDataChannelReader>(); } set { this["Reader"] = value; } }
        public NiagaraDataChannelWriter GetDataChannelWriter() { return Invoke<NiagaraDataChannelWriter>(nameof(GetDataChannelWriter)); }
        public NiagaraDataChannelReader GetDataChannelReader() { return Invoke<NiagaraDataChannelReader>(nameof(GetDataChannelReader)); }
    }
    public class NiagaraDataChannel : Object
    {
        public NiagaraDataChannel(nint addr) : base(addr) { }
        ...
        public bool bKeepPreviousFrameData { get { return this[nameof(bKeepPreviousFrameData)].Flag; } set { this[nameof(bKeepPreviousFrameData)].Flag = value; } }
        public NiagaraDataSetCompiledData CompiledData { get { return this[nameof(CompiledData)].As<NiagaraDataSetCompiledData>(); } set { this["CompiledData"] = value; } }
        public NiagaraDataSetCompiledData CompiledDataGPU { get { return this[nameof(CompiledDataGPU)].As<NiagaraDataSetCompiledData>(); } set { this["CompiledDataGPU"] = value; } }
        public NiagaraDataChannelGameDataLayout GameDataLayout { get { return this[nameof(GameDataLayout)].As<NiagaraDataChannelGameDataLayout>(); } set { this["GameDataLayout"] = value; } }
    }
    public class NiagaraDataChannel_Global : NiagaraDataChannel
    {
        public NiagaraDataChannel_Global(nint addr) : base(addr) { }
    }
    public class NiagaraDataChannelHandler_Global : NiagaraDataChannelHandler
    {
        public NiagaraDataChannelHandler_Global(nint addr) : base(addr) { }
    }
    public class NiagaraDataInterface : NiagaraDataInterfaceBase
    {
        public NiagaraDataInterface(nint addr) : base(addr) { }
    }
    public class NiagaraDataInterfaceDataChannelRead : NiagaraDataInterface
    {
        public NiagaraDataInterfaceDataChannelRead(nint addr) : base(addr) { }
        public NiagaraDataChannelReference Channel { get { return this[nameof(Channel)].As<NiagaraDataChannelReference>(); } set { this["Channel"] = value; } }
        public bool bReadCurrentFrame { get { return this[nameof(bReadCurrentFrame)].Flag; } set { this[nameof(bReadCurrentFrame)].Flag = value; } }
        public NDIDataChannelCompiledData CompiledData { get { return this[nameof(CompiledData)].As<NDIDataChannelCompiledData>(); } set { this["CompiledData"] = value; } }
    }
    public class NiagaraDataInterfaceDataChannelSpawn : NiagaraDataInterfaceDataChannelRead
    {
        public NiagaraDataInterfaceDataChannelSpawn(nint addr) : base(addr) { }
        ...
        public bool bOverrideSpawnGroupToDataChannelIndex { get { return this[nameof(bOverrideSpawnGroupToDataChannelIndex)].Flag; } set { this[nameof(bOverrideSpawnGroupToDataChannelIndex)].Flag = value; } }
    }
    public class NiagaraDataInterfaceDataChannelWrite : NiagaraDataInterface
    {
        public NiagaraDataInterfaceDataChannelWrite(nint addr) : base(addr) { }
        public ENiagaraDataChannelAllocationMode AllocationMode { get { return (ENiagaraDataChannelAllocationMode)this[nameof(AllocationMode)].GetValue<int>(); } set { this[nameof(AllocationMode)].SetValue<int>((int)value); } }
        public uint AllocationCount { get { return this[nameof(AllocationCount)].GetValue<uint>(); } set { this[nameof(AllocationCount)].SetValue<uint>(value); } }
        public bool bPublishToGame { get { return this[nameof(bPublishToGame)].Flag; } set { this[nameof(bPublishToGame)].Flag = value; } }
        public bool bPublishToCPU { get { return this[nameof(bPublishToCPU)].Flag; } set { this[nameof(bPublishToCPU)].Flag = value; } }
        public bool bPublishToGPU { get { return this[nameof(bPublishToGPU)].Flag; } set { this[nameof(bPublishToGPU)].Flag = value; } }
        public NiagaraDataChannelReference Channel { get { return this[nameof(Channel)].As<NiagaraDataChannelReference>(); } set { this["Channel"] = value; } }
        public NDIDataChannelWriteCompiledData CompiledData { get { return this[nameof(CompiledData)].As<NDIDataChannelWriteCompiledData>(); } set { this["CompiledData"] = value; } }
    }
    ...
    public class NiagaraRenderableMeshInterface : Interface
    {
        public NiagaraRenderableMeshInterface(nint addr) : base(addr) { }
    }
    ...
    public class NiagaraSettings : DeveloperSettings
    {
        ...
        public Object SimCacheAuxiliaryFileBasePath { get { return this[nameof(SimCacheAuxiliaryFileBasePath)]; } set { this[nameof(SimCacheAuxiliaryFileBasePath)] = value; } }
        public long SimCacheMaxCPUMemoryVolumetrics { get { return this[nameof(SimCacheMaxCPUMemoryVolumetrics)].GetValue<long>(); } set { this[nameof(SimCacheMaxCPUMemoryVolumetrics)].SetValue<long>(value); } }
    ...
    public class NiagaraSimCacheCustomStorageInterface : Interface
    {
        public NiagaraSimCacheCustomStorageInterface(nint addr) : base(addr) { }
    }
    public class NiagaraValidationRuleSet : Object
    {
        public NiagaraValidationRuleSet(nint addr) : base(addr) { }
    ...
    public class NiagaraDataInterfaceDynamicMesh : NiagaraDataInterface
    {
        public NiagaraDataInterfaceDynamicMesh(nint addr) : base(addr) { }
        public Array<NiagaraDynamicMeshSection> Sections { get { return new Array<NiagaraDynamicMeshSection>(this[nameof(Sections)].Address); } }
        public Array<NiagaraDynamicMeshMaterial> Materials { get { return new Array<NiagaraDynamicMeshMaterial>(this[nameof(Materials)].Address); } }
        public int NumVertices { get { return this[nameof(NumVertices)].GetValue<int>(); } set { this[nameof(NumVertices)].SetValue<int>(value); } }
        public int NumTexCoords { get { return this[nameof(NumTexCoords)].GetValue<int>(); } set { this[nameof(NumTexCoords)].SetValue<int>(value); } }
        public bool bHasColors { get { return this[nameof(bHasColors)].Flag; } set { this[nameof(bHasColors)].Flag = value; } }
        public bool bHasTangentBasis { get { return this[nameof(bHasTangentBasis)].Flag; } set { this[nameof(bHasTangentBasis)].Flag = value; } }
        public bool bClearTrianglesPerFrame { get { return this[nameof(bClearTrianglesPerFrame)].Flag; } set { this[nameof(bClearTrianglesPerFrame)].Flag = value; } }
        public Box DefaultBounds { get { return this[nameof(DefaultBounds)].As<Box>(); } set { this["DefaultBounds"] = value; } }
    }
    ...
    public class NiagaraDataInterfaceStaticMesh : NiagaraDataInterface
    {
        ...
        public bool bAllowSamplingFromStreamingLODs { get { return this[nameof(bAllowSamplingFromStreamingLODs)].Flag; } set { this[nameof(bAllowSamplingFromStreamingLODs)].Flag = value; } }
        public int LODIndex { get { return this[nameof(LODIndex)].GetValue<int>(); } set { this[nameof(LODIndex)].SetValue<int>(value); } }
        public NiagaraUserParameterBinding LODIndexUserParameter { get { return this[nameof(LODIndexUserParameter)].As<NiagaraUserParameterBinding>(); } set { this["LODIndexUserParameter"] = value; } }
    ...
    public class NiagaraComponent : FXSystemComponent
    {
        ...
        public bool bOverrideWarmupSettings { get { return this[nameof(bOverrideWarmupSettings)].Flag; } set { this[nameof(bOverrideWarmupSettings)].Flag = value; } }
    ...
    public class NiagaraDataChannelLibrary : BlueprintFunctionLibrary
    {
        public NiagaraDataChannelLibrary(nint addr) : base(addr) { }
        public NiagaraDataChannelHandler GetNiagaraDataChannel(Object WorldContextObject, Object Channel) { return Invoke<NiagaraDataChannelHandler>(nameof(GetNiagaraDataChannel), WorldContextObject, Channel); }
    }
    ...
    public class NiagaraDataInterfaceAudioPlayerSettings : Object
    {
        public NiagaraDataInterfaceAudioPlayerSettings(nint addr) : base(addr) { }
        ...
        public bool bOverrideAttenuationSettings { get { return this[nameof(bOverrideAttenuationSettings)].Flag; } set { this[nameof(bOverrideAttenuationSettings)].Flag = value; } }
        public SoundAttenuationSettings AttenuationSettings { get { return this[nameof(AttenuationSettings)].As<SoundAttenuationSettings>(); } set { this["AttenuationSettings"] = value; } }
    }
    public class NiagaraDataInterfaceAudioPlayer : NiagaraDataInterface
    {
        ...
        public NiagaraUserParameterBinding ConfigurationUserParameter { get { return this[nameof(ConfigurationUserParameter)].As<NiagaraUserParameterBinding>(); } set { this["ConfigurationUserParameter"] = value; } }
    ...
    public class NiagaraDataInterfaceGrid2D : NiagaraDataInterfaceRWBase
    {
        ...
        public bool ClearBeforeNonIterationStage { get { return this[nameof(ClearBeforeNonIterationStage)].Flag; } set { this[nameof(ClearBeforeNonIterationStage)].Flag = value; } }
    ...
    public class NiagaraDataInterfaceRenderTarget2D : NiagaraDataInterfaceRWBase
    {
        ...
        public byte OverrideRenderTargetFilter { get { return this[nameof(OverrideRenderTargetFilter)].GetValue<byte>(); } set { this[nameof(OverrideRenderTargetFilter)].SetValue<byte>(value); } }
    ...
    public class NiagaraDataInterfaceRigidMeshCollisionQuery : NiagaraDataInterface
    {
        ...
        public bool UseComplexCollisions { get { return this[nameof(UseComplexCollisions)].Flag; } set { this[nameof(UseComplexCollisions)].Flag = value; } }
    ...
    public class NiagaraDecalRendererProperties : NiagaraRendererProperties
    {
        public NiagaraDecalRendererProperties(nint addr) : base(addr) { }
        public MaterialInterface Material { get { return this[nameof(Material)].As<MaterialInterface>(); } set { this["Material"] = value; } }
        public NiagaraParameterBinding MaterialParameterBinding { get { return this[nameof(MaterialParameterBinding)].As<NiagaraParameterBinding>(); } set { this["MaterialParameterBinding"] = value; } }
        ...
        public int RendererVisibility { get { return this[nameof(RendererVisibility)].GetValue<int>(); } set { this[nameof(RendererVisibility)].SetValue<int>(value); } }
        public float DecalScreenSizeFade { get { return this[nameof(DecalScreenSizeFade)].GetValue<float>(); } set { this[nameof(DecalScreenSizeFade)].SetValue<float>(value); } }
        ...
        public NiagaraVariableAttributeBinding DecalOrientationBinding { get { return this[nameof(DecalOrientationBinding)].As<NiagaraVariableAttributeBinding>(); } set { this["DecalOrientationBinding"] = value; } }
        public NiagaraVariableAttributeBinding DecalSizeBinding { get { return this[nameof(DecalSizeBinding)].As<NiagaraVariableAttributeBinding>(); } set { this["DecalSizeBinding"] = value; } }
        public NiagaraVariableAttributeBinding DecalFadeBinding { get { return this[nameof(DecalFadeBinding)].As<NiagaraVariableAttributeBinding>(); } set { this["DecalFadeBinding"] = value; } }
        public NiagaraVariableAttributeBinding DecalSortOrderBinding { get { return this[nameof(DecalSortOrderBinding)].As<NiagaraVariableAttributeBinding>(); } set { this["DecalSortOrderBinding"] = value; } }
        public NiagaraVariableAttributeBinding DecalColorBinding { get { return this[nameof(DecalColorBinding)].As<NiagaraVariableAttributeBinding>(); } set { this["DecalColorBinding"] = value; } }
        public NiagaraVariableAttributeBinding DecalVisibleBinding { get { return this[nameof(DecalVisibleBinding)].As<NiagaraVariableAttributeBinding>(); } set { this["DecalVisibleBinding"] = value; } }
        public NiagaraVariableAttributeBinding RendererVisibilityTagBinding { get { return this[nameof(RendererVisibilityTagBinding)].As<NiagaraVariableAttributeBinding>(); } set { this["RendererVisibilityTagBinding"] = value; } }
    ...
    public class NiagaraMeshRendererProperties : NiagaraRendererProperties
    {
        ...
        public bool bUseHeterogeneousVolumes { get { return this[nameof(bUseHeterogeneousVolumes)].Flag; } set { this[nameof(bUseHeterogeneousVolumes)].Flag = value; } }
        ...
        public Array<NiagaraMeshMICOverride> MICOverrideMaterials { get { return new Array<NiagaraMeshMICOverride>(this[nameof(MICOverrideMaterials)].Address); } }
        ...
        public Vector MeshBoundsScale { get { return this[nameof(MeshBoundsScale)].As<Vector>(); } set { this["MeshBoundsScale"] = value; } }
    ...
    public class NiagaraSimCache : Object
    {
        ...
        public Guid CacheGuid { get { return this[nameof(CacheGuid)].As<Guid>(); } set { this["CacheGuid"] = value; } }
    ...
    public class NiagaraSimulationStageGeneric : NiagaraSimulationStageBase
    {
        ...
        public ENiagaraGpuDispatchType DirectDispatchType { get { return (ENiagaraGpuDispatchType)this[nameof(DirectDispatchType)].GetValue<int>(); } set { this[nameof(DirectDispatchType)].SetValue<int>((int)value); } }
        public ENiagaraDirectDispatchElementType DirectDispatchElementType { get { return (ENiagaraDirectDispatchElementType)this[nameof(DirectDispatchElementType)].GetValue<int>(); } set { this[nameof(DirectDispatchElementType)].SetValue<int>((int)value); } }
    ...
    public class NiagaraSystem : FXSystemAsset
    {
        ...
        public Array<NiagaraDataChannelDefinitions> ReferencedDataChannelDefinitions { get { return new Array<NiagaraDataChannelDefinitions>(this[nameof(ReferencedDataChannelDefinitions)].Address); } }
    }
    ...
    public class NiagaraSimCacheCreateParameters : Object
    {
        ...
        public bool bAllowInterpolation { get { return this[nameof(bAllowInterpolation)].Flag; } set { this[nameof(bAllowInterpolation)].Flag = value; } }
        public bool bAllowVelocityExtrapolation { get { return this[nameof(bAllowVelocityExtrapolation)].Flag; } set { this[nameof(bAllowVelocityExtrapolation)].Flag = value; } }
        ...
        public Array<Object> InterpolationIncludeAttributes { get { return new Array<Object>(this[nameof(InterpolationIncludeAttributes)].Address); } }
        public Array<Object> InterpolationExcludeAttributes { get { return new Array<Object>(this[nameof(InterpolationExcludeAttributes)].Address); } }
    ...
    public enum ENiagaraBaseTypes : int
    {
        Half = 0,
        Float = 1,
        Int32 = 2,
    ...
    public enum ENiagaraDataChannelAllocationMode : int
    {
        Static = 0,
    ...
    public class NDIRenderTargetVolumeSimCacheFrame : Object
    {
        public NDIRenderTargetVolumeSimCacheFrame(nint addr) : base(addr) { }
        public IntVector Size { get { return this[nameof(Size)].As<IntVector>(); } set { this["Size"] = value; } }
        ...
        public int CompressedSize { get { return this[nameof(CompressedSize)].GetValue<int>(); } set { this[nameof(CompressedSize)].SetValue<int>(value); } }
    }
    ...
    public class NiagaraFunctionSignature : Object
    {
        ...
        public short RequiredInputs { get { return this[nameof(RequiredInputs)].GetValue<short>(); } set { this[nameof(RequiredInputs)].SetValue<short>(value); } }
        public short RequiredOutputs { get { return this[nameof(RequiredOutputs)].GetValue<short>(); } set { this[nameof(RequiredOutputs)].SetValue<short>(value); } }
    ...
    public class VMExternalFunctionBindingInfo : Object
    {
        ...
        public Array<NiagaraVariableBase> VariadicInputs { get { return new Array<NiagaraVariableBase>(this[nameof(VariadicInputs)].Address); } }
        public Array<NiagaraVariableBase> VariadicOutputs { get { return new Array<NiagaraVariableBase>(this[nameof(VariadicOutputs)].Address); } }
    }
    ...
    public class NiagaraDataChannelReference : Object
    {
        public NiagaraDataChannelReference(nint addr) : base(addr) { }
        public Object ChannelName { get { return this[nameof(ChannelName)]; } set { this[nameof(ChannelName)] = value; } }
    }
    public class NDIDataChannelFunctionInfo : Object
    {
        public NDIDataChannelFunctionInfo(nint addr) : base(addr) { }
        public Object FunctionName { get { return this[nameof(FunctionName)]; } set { this[nameof(FunctionName)] = value; } }
        public Array<NiagaraVariableBase> Inputs { get { return new Array<NiagaraVariableBase>(this[nameof(Inputs)].Address); } }
        public Array<NiagaraVariableBase> Outputs { get { return new Array<NiagaraVariableBase>(this[nameof(Outputs)].Address); } }
    }
    public class NDIDataChannel_GPUScriptParameterAccessInfo : Object
    {
        public NDIDataChannel_GPUScriptParameterAccessInfo(nint addr) : base(addr) { }
        public Array<NiagaraVariableBase> SortedParameters { get { return new Array<NiagaraVariableBase>(this[nameof(SortedParameters)].Address); } }
    }
    public class NDIDataChannelCompiledData : Object
    {
        public NDIDataChannelCompiledData(nint addr) : base(addr) { }
        public Array<NDIDataChannelFunctionInfo> FunctionInfo { get { return new Array<NDIDataChannelFunctionInfo>(this[nameof(FunctionInfo)].Address); } }
        public Object GPUScriptParameterInfos { get { return this[nameof(GPUScriptParameterInfos)]; } set { this[nameof(GPUScriptParameterInfos)] = value; } }
        public uint TotalParams { get { return this[nameof(TotalParams)].GetValue<uint>(); } set { this[nameof(TotalParams)].SetValue<uint>(value); } }
        public bool bUsedByCPU { get { return this[nameof(bUsedByCPU)].Flag; } set { this[nameof(bUsedByCPU)].Flag = value; } }
        public bool bUsedByGPU { get { return this[nameof(bUsedByGPU)].Flag; } set { this[nameof(bUsedByGPU)].Flag = value; } }
    }
    public class NDIDataChannelWriteCompiledData : NDIDataChannelCompiledData
    {
        public NDIDataChannelWriteCompiledData(nint addr) : base(addr) { }
        public NiagaraDataSetCompiledData DataLayout { get { return this[nameof(DataLayout)].As<NiagaraDataSetCompiledData>(); } set { this["DataLayout"] = value; } }
    }
    ...
    public class NiagaraParameterBinding : Object
    {
        public NiagaraParameterBinding(nint addr) : base(addr) { }
        public NiagaraVariableBase Parameter { get { return this[nameof(Parameter)].As<NiagaraVariableBase>(); } set { this["Parameter"] = value; } }
    }
    ...
    public class NiagaraSimCacheCaptureParameters : Object
    {
        public NiagaraSimCacheCaptureParameters(nint addr) : base(addr) { }
        public int NumFrames { get { return this[nameof(NumFrames)].GetValue<int>(); } set { this[nameof(NumFrames)].SetValue<int>(value); } }
        public int CaptureRate { get { return this[nameof(CaptureRate)].GetValue<int>(); } set { this[nameof(CaptureRate)].SetValue<int>(value); } }
        public bool bManuallyAdvanceSimulation { get { return this[nameof(bManuallyAdvanceSimulation)].Flag; } set { this[nameof(bManuallyAdvanceSimulation)].Flag = value; } }
    ...
    public class NiagaraDynamicMeshSection : Object
    {
        public NiagaraDynamicMeshSection(nint addr) : base(addr) { }
        public int NumTriangles { get { return this[nameof(NumTriangles)].GetValue<int>(); } set { this[nameof(NumTriangles)].SetValue<int>(value); } }
    ...
    public class NiagaraDynamicMeshMaterial : Object
    {
        public NiagaraDynamicMeshMaterial(nint addr) : base(addr) { }
        public MaterialInterface Material { get { return this[nameof(Material)].As<MaterialInterface>(); } set { this["Material"] = value; } }
        public NiagaraUserParameterBinding MaterialUserParamBinding { get { return this[nameof(MaterialUserParamBinding)].As<NiagaraUserParameterBinding>(); } set { this["MaterialUserParamBinding"] = value; } }
    }
    ...
    public class NiagaraDataChannelGameDataLayout : Object
    {
        public NiagaraDataChannelGameDataLayout(nint addr) : base(addr) { }
        public Object VariableIndices { get { return this[nameof(VariableIndices)]; } set { this[nameof(VariableIndices)] = value; } }
        public Array<NiagaraLwcStructConverter> LwcConverters { get { return new Array<NiagaraLwcStructConverter>(this[nameof(LwcConverters)].Address); } }
    }
    public class NiagaraLwcStructConverter : Object
    {
        public NiagaraLwcStructConverter(nint addr) : base(addr) { }
        public int LWCSize { get { return this[nameof(LWCSize)].GetValue<int>(); } set { this[nameof(LWCSize)].SetValue<int>(value); } }
        public int SWCSize { get { return this[nameof(SWCSize)].GetValue<int>(); } set { this[nameof(SWCSize)].SetValue<int>(value); } }
    ...
    public class NiagaraStructConversionStep : Object
    {
        ...
        public int LWCBytes { get { return this[nameof(LWCBytes)].GetValue<int>(); } set { this[nameof(LWCBytes)].SetValue<int>(value); } }
        public int LWCOffset { get { return this[nameof(LWCOffset)].GetValue<int>(); } set { this[nameof(LWCOffset)].SetValue<int>(value); } }
    ...
    public class NiagaraDebugHUDSettingsData : Object
    {
        ...
        public float SystemBoundsSolidBoxAlpha { get { return this[nameof(SystemBoundsSolidBoxAlpha)].GetValue<float>(); } set { this[nameof(SystemBoundsSolidBoxAlpha)].SetValue<float>(value); } }
    ...
    public class NiagaraMeshMICOverride : Object
    {
        public NiagaraMeshMICOverride(nint addr) : base(addr) { }
        ...
        public MaterialInstanceConstant ReplacementMaterial { get { return this[nameof(ReplacementMaterial)].As<MaterialInstanceConstant>(); } set { this["ReplacementMaterial"] = value; } }
    }
    ...
    public class NiagaraMeshRendererMeshProperties : Object
    {
        ...
        public NiagaraParameterBinding MeshParameterBinding { get { return this[nameof(MeshParameterBinding)].As<NiagaraParameterBinding>(); } set { this["MeshParameterBinding"] = value; } }
    ...
    public class NiagaraRendererMaterialStaticBoolParameter : Object
    {
        public NiagaraRendererMaterialStaticBoolParameter(nint addr) : base(addr) { }
        public Object MaterialParameterName { get { return this[nameof(MaterialParameterName)]; } set { this[nameof(MaterialParameterName)] = value; } }
        public Object StaticVariableName { get { return this[nameof(StaticVariableName)]; } set { this[nameof(StaticVariableName)] = value; } }
    }
    public class NiagaraRendererMaterialParameters : Object
    {
        ...
        public Array<NiagaraRendererMaterialStaticBoolParameter> StaticBoolParameters { get { return new Array<NiagaraRendererMaterialStaticBoolParameter>(this[nameof(StaticBoolParameters)].Address); } }
    }
    ...
    public class NiagaraSimCacheDataBuffers : Object
    {
        ...
        public Array<uint> InterpMapping { get { return new Array<uint>(this[nameof(InterpMapping)].Address); } }
    }
    ...
    public class NiagaraSimCacheFrame : Object
    {
        ...
        public Vector3f LWCTile { get { return this[nameof(LWCTile)].As<Vector3f>(); } set { this["LWCTile"] = value; } }
        public float SimulationAge { get { return this[nameof(SimulationAge)].GetValue<float>(); } set { this[nameof(SimulationAge)].SetValue<float>(value); } }
    ...
    public class NiagaraSimCacheDataBuffersLayout : Object
    {
        ...
        public Array<Object> InterpVariableNames { get { return new Array<Object>(this[nameof(InterpVariableNames)].Address); } }
        public ushort ComponentVelocity { get { return this[nameof(ComponentVelocity)].GetValue<ushort>(); } set { this[nameof(ComponentVelocity)].SetValue<ushort>(value); } }
    }
    ...
    public class NiagaraDouble : Object
    {
        public NiagaraDouble(nint addr) : base(addr) { }
