...
namespace SDK.Script.ConstraintsSDK
{
    ...
    public class ConstraintsScriptingLibrary : BlueprintFunctionLibrary
    {
        ...
        public bool RemoveThisConstraint(World InWorld, TickableConstraint InTickableConstraint) { return Invoke<bool>(nameof(RemoveThisConstraint), InWorld, InTickableConstraint); }
        ...
        public Array<TickableConstraint> GetConstraintsArray(World InWorld) { return Invoke<Array<TickableConstraint>>(nameof(GetConstraintsArray), InWorld); }
        public TransformableHandle CreateTransformableHandle(World InWorld, Object InObject, Object InAttachmentName) { return Invoke<TransformableHandle>(nameof(CreateTransformableHandle), InWorld, InObject, InAttachmentName); }
    ...
    public class TickableTranslationConstraint : TickableTransformConstraint
    {
        ...
        public FilterOptionPerAxis AxisFilter { get { return this[nameof(AxisFilter)].As<FilterOptionPerAxis>(); } set { this["AxisFilter"] = value; } }
    }
    ...
    public class TickableParentConstraint : TickableTransformConstraint
    {
        ...
        public TransformFilter TransformFilter { get { return this[nameof(TransformFilter)].As<TransformFilter>(); } set { this["TransformFilter"] = value; } }
    }
