...
namespace SDK.Script.OnlineSubsystemEOSSDK
{
    ...
    public class EOSSettings : RuntimeOptionsBase
    {
        ...
        public Array<Object> AuthScopeFlags { get { return new Array<Object>(this[nameof(AuthScopeFlags)].Address); } }
    ...
    public class ArtifactSettings : Object
    {
        ...
        public Object ClientEncryptionKey { get { return this[nameof(ClientEncryptionKey)]; } set { this[nameof(ClientEncryptionKey)] = value; } }
    }
}
