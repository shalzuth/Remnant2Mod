...
namespace SDK.Script.MediaPlateSDK
{
    ...
    public class MediaPlateComponent : ActorComponent
    {
        ...
        public bool bEnableMipMapUpscaling { get { return this[nameof(bEnableMipMapUpscaling)].Flag; } set { this[nameof(bEnableMipMapUpscaling)].Flag = value; } }
        public int MipLevelToUpscale { get { return this[nameof(MipLevelToUpscale)].GetValue<int>(); } set { this[nameof(MipLevelToUpscale)].SetValue<int>(value); } }
        ...
        public Array<MediaTexture> MediaTextures { get { return new Array<MediaTexture>(this[nameof(MediaTextures)].Address); } }
        ...
        public void SetIsAspectRatioAuto(bool bInIsAspectRatioAuto) { Invoke(nameof(SetIsAspectRatioAuto), bInIsAspectRatioAuto); }
        ...
        public MediaTexture GetMediaTexture(int Index) { return Invoke<MediaTexture>(nameof(GetMediaTexture), Index); }
        ...
        public bool GetIsAspectRatioAuto() { return Invoke<bool>(nameof(GetIsAspectRatioAuto)); }
        public void Close() { Invoke(nameof(Close)); }
    }
    public enum EMediaPlateEventState : int
    {
        Play = 0,
        Open = 1,
        Close = 2,
