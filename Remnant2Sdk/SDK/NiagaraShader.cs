...
namespace SDK.Script.NiagaraShaderSDK
{
    ...
    public enum ENiagaraDirectDispatchElementType : int
    {
        NumThreads = 0,
    ...
    public class SimulationStageMetaData : Object
    {
        ...
        public ENiagaraIterationSource IterationSourceType { get { return (ENiagaraIterationSource)this[nameof(IterationSourceType)].GetValue<int>(); } set { this[nameof(IterationSourceType)].SetValue<int>((int)value); } }
        public Object IterationDataInterface { get { return this[nameof(IterationDataInterface)]; } set { this[nameof(IterationDataInterface)] = value; } }
        public Object IterationDirectBinding { get { return this[nameof(IterationDirectBinding)]; } set { this[nameof(IterationDirectBinding)] = value; } }
        ...
        public bool bGpuIndirectDispatch { get { return this[nameof(bGpuIndirectDispatch)].Flag; } set { this[nameof(bGpuIndirectDispatch)].Flag = value; } }
        ...
        public ENiagaraDirectDispatchElementType GpuDirectDispatchElementType { get { return (ENiagaraDirectDispatchElementType)this[nameof(GpuDirectDispatchElementType)].GetValue<int>(); } set { this[nameof(GpuDirectDispatchElementType)].SetValue<int>((int)value); } }
    ...
    public class NiagaraDataInterfaceGeneratedFunction : Object
    {
        ...
        public Array<NiagaraVariableCommonReference> VariadicInputs { get { return new Array<NiagaraVariableCommonReference>(this[nameof(VariadicInputs)].Address); } }
        public Array<NiagaraVariableCommonReference> VariadicOutputs { get { return new Array<NiagaraVariableCommonReference>(this[nameof(VariadicOutputs)].Address); } }
    }
