...
namespace SDK.Script.ModelingOperatorsSDK
{
    public class RecomputeUVsToolProperties : InteractiveToolPropertySet
    {
        ...
        public bool bEnableUDIMLayout { get { return this[nameof(bEnableUDIMLayout)].Flag; } set { this[nameof(bEnableUDIMLayout)].Flag = value; } }
        public bool bUDIMCVAREnabled { get { return this[nameof(bUDIMCVAREnabled)].Flag; } set { this[nameof(bUDIMCVAREnabled)].Flag = value; } }
    }
