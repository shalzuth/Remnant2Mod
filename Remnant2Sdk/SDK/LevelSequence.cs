...
namespace SDK.Script.LevelSequenceSDK
{
    ...
    public class LevelSequenceDirector : Object
    {
        ...
        public QualifiedFrameTime GetRootSequenceTime() { return Invoke<QualifiedFrameTime>(nameof(GetRootSequenceTime)); }
    ...
    public class LevelSequencePlayerSnapshot : Object
    {
        ...
        public QualifiedFrameTime RootTime { get { return this[nameof(RootTime)].As<QualifiedFrameTime>(); } set { this["RootTime"] = value; } }
