...
namespace SDK.Script.ModelingComponentsSDK
{
    ...
    public class SingleTargetWithSelectionToolBuilder : InteractiveToolWithToolTargetsBuilder
    {
        public SingleTargetWithSelectionToolBuilder(nint addr) : base(addr) { }
    }
    public class SingleTargetWithSelectionTool : SingleSelectionTool
    {
        public SingleTargetWithSelectionTool(nint addr) : base(addr) { }
        public Object TargetWorld { get { return this[nameof(TargetWorld)]; } set { this[nameof(TargetWorld)] = value; } }
    }
    ...
    public class MeshTopologySelectionMechanic : InteractionMechanic
    {
        public MeshTopologySelectionMechanic(nint addr) : base(addr) { }
        public MeshTopologySelectionMechanicProperties Properties { get { return this[nameof(Properties)].As<MeshTopologySelectionMechanicProperties>(); } set { this["Properties"] = value; } }
    ...
    public class BoundarySelectionMechanic : MeshTopologySelectionMechanic
    {
        public BoundarySelectionMechanic(nint addr) : base(addr) { }
    }
    ...
    public class MeshTopologySelectionMechanicProperties : InteractiveToolPropertySet
    {
        public MeshTopologySelectionMechanicProperties(nint addr) : base(addr) { }
    ...
    public class GeometrySelectionEditCommandResult : InteractiveCommandResult
    {
        public GeometrySelectionEditCommandResult(nint addr) : base(addr) { }
    }
    ...
    public class ConstructionPlaneMechanic : InteractionMechanic
    {
        ...
        public LocalSingleClickInputBehavior MiddleClickToSetGizmoBehavior { get { return this[nameof(MiddleClickToSetGizmoBehavior)].As<LocalSingleClickInputBehavior>(); } set { this["MiddleClickToSetGizmoBehavior"] = value; } }
    }
    ...
    public class DragAlignmentInteraction : Object
    {
        public DragAlignmentInteraction(nint addr) : base(addr) { }
    }
    ...
    public class RectangleMarqueeInteraction : Object
    {
        public RectangleMarqueeInteraction(nint addr) : base(addr) { }
    }
    ...
    public class ModelingComponentsEditorSettings : DeveloperSettings
    {
        public ModelingComponentsEditorSettings(nint addr) : base(addr) { }
        public EModelingComponentsPlaneVisualizationMode GridMode { get { return (EModelingComponentsPlaneVisualizationMode)this[nameof(GridMode)].GetValue<int>(); } set { this[nameof(GridMode)].SetValue<int>((int)value); } }
        public int NumGridLines { get { return this[nameof(NumGridLines)].GetValue<int>(); } set { this[nameof(NumGridLines)].SetValue<int>(value); } }
        public float GridSpacing { get { return this[nameof(GridSpacing)].GetValue<float>(); } set { this[nameof(GridSpacing)].SetValue<float>(value); } }
        public float GridScale { get { return this[nameof(GridScale)].GetValue<float>(); } set { this[nameof(GridScale)].SetValue<float>(value); } }
    ...
    public class PolygonSelectionMechanicProperties : MeshTopologySelectionMechanicProperties
    {
        public PolygonSelectionMechanicProperties(nint addr) : base(addr) { }
    }
    public class PolygonSelectionMechanic : MeshTopologySelectionMechanic
    {
    ...
    public enum EModelingComponentsPlaneVisualizationMode : int
    {
        SimpleGrid = 0,
        HierarchicalGrid = 1,
