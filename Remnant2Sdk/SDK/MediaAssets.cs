...
namespace SDK.Script.MediaAssetsSDK
{
    ...
    public class MediaSourceRendererInterface : Interface
    {
        public MediaSourceRendererInterface(nint addr) : base(addr) { }
    }
    ...
    public class MediaPlayer : Object
    {
        ...
        public Object OnMetadataChanged { get { return this[nameof(OnMetadataChanged)]; } set { this[nameof(OnMetadataChanged)] = value; } }
