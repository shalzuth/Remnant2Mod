...
namespace SDK.Script.InteractiveToolsFrameworkSDK
{
    ...
    public class InteractiveCommandResult : Object
    {
        public InteractiveCommandResult(nint addr) : base(addr) { }
    }
    ...
    public class CombinedTransformGizmoActor : GizmoActor
    {
        ...
        public PrimitiveComponent RotationSphere { get { return this[nameof(RotationSphere)].As<PrimitiveComponent>(); } set { this["RotationSphere"] = value; } }
    ...
    public class CombinedTransformGizmo : InteractiveGizmo
    {
        ...
        public bool bUseContextGizmoMode { get { return this[nameof(bUseContextGizmoMode)].Flag; } set { this[nameof(bUseContextGizmoMode)].Flag = value; } }
        public EToolContextTransformGizmoMode ActiveGizmoMode { get { return (EToolContextTransformGizmoMode)this[nameof(ActiveGizmoMode)].GetValue<int>(); } set { this[nameof(ActiveGizmoMode)].SetValue<int>((int)value); } }
    ...
    public enum EToolContextTransformGizmoMode : int
    {
        NoGizmo = 0,
        Translation = 1,
        Rotation = 2,
    ...
    public enum EToolShutdownType : int
    {
        Completed = 0,
        Accept = 1,
        Cancel = 2,
    ...
    public class InputRayHit : Object
    {
        ...
        public double HitDepth { get { return this[nameof(HitDepth)].GetValue<double>(); } set { this[nameof(HitDepth)].SetValue<double>(value); } }
        public Vector HitNormal { get { return this[nameof(HitNormal)].As<Vector>(); } set { this["HitNormal"] = value; } }
        public bool bHasHitNormal { get { return this[nameof(bHasHitNormal)].Flag; } set { this[nameof(bHasHitNormal)].Flag = value; } }
        public int HitIdentifier { get { return this[nameof(HitIdentifier)].GetValue<int>(); } set { this[nameof(HitIdentifier)].SetValue<int>(value); } }
        public Object HitObject { get { return this[nameof(HitObject)]; } set { this[nameof(HitObject)] = value; } }
    }
    public class InputDeviceRay : Object
    {
        public InputDeviceRay(nint addr) : base(addr) { }
        public Ray WorldRay { get { return this[nameof(WorldRay)].As<Ray>(); } set { this["WorldRay"] = value; } }
        public bool bHas2D { get { return this[nameof(bHas2D)].Flag; } set { this[nameof(bHas2D)].Flag = value; } }
        public Vector2D ScreenPosition { get { return this[nameof(ScreenPosition)].As<Vector2D>(); } set { this["ScreenPosition"] = value; } }
    }
