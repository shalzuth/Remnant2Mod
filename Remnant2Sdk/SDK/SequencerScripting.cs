...
namespace SDK.Script.SequencerScriptingSDK
{
    ...
    public class MovieSceneBindingExtensions : BlueprintFunctionLibrary
    {
        ...
        public void SetSpawnableBindingID(MovieSceneBindingProxy InBinding, MovieSceneObjectBindingID SpawnableBindingID) { Invoke(nameof(SetSpawnableBindingID), InBinding, SpawnableBindingID); }
        public void SetSortingOrder(MovieSceneBindingProxy InBinding, int SortingOrder) { Invoke(nameof(SetSortingOrder), InBinding, SortingOrder); }
        ...
        public int GetSortingOrder(MovieSceneBindingProxy InBinding) { return Invoke<int>(nameof(GetSortingOrder), InBinding); }
    ...
    public class MovieSceneFolderExtensions : BlueprintFunctionLibrary
    {
        ...
        public bool RemoveChildTrack(MovieSceneFolder Folder, MovieSceneTrack InTrack) { return Invoke<bool>(nameof(RemoveChildTrack), Folder, InTrack); }
        ...
        public bool RemoveChildMasterTrack(MovieSceneFolder Folder, MovieSceneTrack InTrack) { return Invoke<bool>(nameof(RemoveChildMasterTrack), Folder, InTrack); }
        ...
        public Array<MovieSceneTrack> GetChildTracks(MovieSceneFolder Folder) { return Invoke<Array<MovieSceneTrack>>(nameof(GetChildTracks), Folder); }
        ...
        public bool AddChildTrack(MovieSceneFolder Folder, MovieSceneTrack InTrack) { return Invoke<bool>(nameof(AddChildTrack), Folder, InTrack); }
        ...
        public bool AddChildMasterTrack(MovieSceneFolder Folder, MovieSceneTrack InTrack) { return Invoke<bool>(nameof(AddChildMasterTrack), Folder, InTrack); }
    ...
    public class MovieSceneSequenceExtensions : BlueprintFunctionLibrary
    {
        ...
        public MovieSceneBindingProxy ResolveBindingID(MovieSceneSequence RootSequence, MovieSceneObjectBindingID InObjectBindingID) { return Invoke<MovieSceneBindingProxy>(nameof(ResolveBindingID), RootSequence, InObjectBindingID); }
        public bool RemoveTrack(MovieSceneSequence Sequence, MovieSceneTrack Track) { return Invoke<bool>(nameof(RemoveTrack), Sequence, Track); }
        ...
        public bool RemoveMasterTrack(MovieSceneSequence Sequence, MovieSceneTrack Track) { return Invoke<bool>(nameof(RemoveMasterTrack), Sequence, Track); }
        ...
        public MovieSceneObjectBindingID MakeBindingID(MovieSceneSequence Sequence, MovieSceneBindingProxy InBinding, EMovieSceneObjectBindingSpace Space) { return Invoke<MovieSceneObjectBindingID>(nameof(MakeBindingID), Sequence, InBinding, Space); }
        ...
        public Array<MovieSceneTrack> GetTracks(MovieSceneSequence Sequence) { return Invoke<Array<MovieSceneTrack>>(nameof(GetTracks), Sequence); }
        ...
        public MovieSceneObjectBindingID GetPortableBindingID(MovieSceneSequence RootSequence, MovieSceneSequence DestinationSequence, MovieSceneBindingProxy InBinding) { return Invoke<MovieSceneObjectBindingID>(nameof(GetPortableBindingID), RootSequence, DestinationSequence, InBinding); }
        ...
        public Array<MovieSceneTrack> FindTracksByType(MovieSceneSequence Sequence, Object TrackType) { return Invoke<Array<MovieSceneTrack>>(nameof(FindTracksByType), Sequence, TrackType); }
        public Array<MovieSceneTrack> FindTracksByExactType(MovieSceneSequence Sequence, Object TrackType) { return Invoke<Array<MovieSceneTrack>>(nameof(FindTracksByExactType), Sequence, TrackType); }
        ...
        public MovieSceneTrack AddTrack(MovieSceneSequence Sequence, Object TrackType) { return Invoke<MovieSceneTrack>(nameof(AddTrack), Sequence, TrackType); }
