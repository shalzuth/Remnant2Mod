...
{
    public class MetasoundGeneratorHandle : Object
    {
        public MetasoundGeneratorHandle(nint addr) : base(addr) { }
        ...
        public MetaSoundSource CachedMetasoundSource { get { return this[nameof(CachedMetasoundSource)].As<MetaSoundSource>(); } set { this["CachedMetasoundSource"] = value; } }
        public MetasoundGeneratorHandle CreateMetaSoundGeneratorHandle(AudioComponent OnComponent) { return Invoke<MetasoundGeneratorHandle>(nameof(CreateMetaSoundGeneratorHandle), OnComponent); }
        public bool ApplyParameterPack(MetasoundParameterPack Pack) { return Invoke<bool>(nameof(ApplyParameterPack), Pack); }
    }
