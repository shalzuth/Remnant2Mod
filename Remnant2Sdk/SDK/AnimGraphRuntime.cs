...
{
    public class BlendSpaceLibrary : BlueprintFunctionLibrary
    {
        public BlendSpaceLibrary(nint addr) : base(addr) { }
        public void SnapToPosition(BlendSpaceReference BlendSpace, Vector NewPosition) { Invoke(nameof(SnapToPosition), BlendSpace, NewPosition); }
        public Vector GetPosition(BlendSpaceReference BlendSpace) { return Invoke<Vector>(nameof(GetPosition), BlendSpace); }
        public Vector GetFilteredPosition(BlendSpaceReference BlendSpace) { return Invoke<Vector>(nameof(GetFilteredPosition), BlendSpace); }
        public void ConvertToBlendSpacePure(AnimNodeReference Node, BlendSpaceReference BlendSpace, bool Result) { Invoke(nameof(ConvertToBlendSpacePure), Node, BlendSpace, Result); }
        public BlendSpaceReference ConvertToBlendSpace(AnimNodeReference Node, EAnimNodeReferenceConversionResult Result) { return Invoke<BlendSpaceReference>(nameof(ConvertToBlendSpace), Node, Result); }
    }
    ...
    public class BlendSpacePlayerLibrary : BlueprintFunctionLibrary
    {
        ...
        public void SnapToPosition(BlendSpacePlayerReference BlendSpacePlayer, Vector NewPosition) { Invoke(nameof(SnapToPosition), BlendSpacePlayer, NewPosition); }
    ...
    public class BlendSpaceReference : AnimNodeReference
    {
        public BlendSpaceReference(nint addr) : base(addr) { }
    }
    ...
    public class AnimNode_BoneDrivenController : AnimNode_SkeletalControlBase
    {
        ...
        public float Multiplier { get { return this[nameof(Multiplier)].GetValue<float>(); } set { this[nameof(Multiplier)].SetValue<float>(value); } }
        public double RangeMin { get { return this[nameof(RangeMin)].GetValue<double>(); } set { this[nameof(RangeMin)].SetValue<double>(value); } }
        public double RangeMax { get { return this[nameof(RangeMax)].GetValue<double>(); } set { this[nameof(RangeMax)].SetValue<double>(value); } }
        public double RemappedMin { get { return this[nameof(RemappedMin)].GetValue<double>(); } set { this[nameof(RemappedMin)].SetValue<double>(value); } }
        public double RemappedMax { get { return this[nameof(RemappedMax)].GetValue<double>(); } set { this[nameof(RemappedMax)].SetValue<double>(value); } }
    ...
    public class AnimNode_SpringBone : AnimNode_SkeletalControlBase
    {
        ...
        public double MaxDisplacement { get { return this[nameof(MaxDisplacement)].GetValue<double>(); } set { this[nameof(MaxDisplacement)].SetValue<double>(value); } }
        public double SpringStiffness { get { return this[nameof(SpringStiffness)].GetValue<double>(); } set { this[nameof(SpringStiffness)].SetValue<double>(value); } }
        public double SpringDamping { get { return this[nameof(SpringDamping)].GetValue<double>(); } set { this[nameof(SpringDamping)].SetValue<double>(value); } }
        public double ErrorResetThresh { get { return this[nameof(ErrorResetThresh)].GetValue<double>(); } set { this[nameof(ErrorResetThresh)].SetValue<double>(value); } }
    ...
    public class AnimNode_TwoBoneIK : AnimNode_SkeletalControlBase
    {
        ...
        public double StartStretchRatio { get { return this[nameof(StartStretchRatio)].GetValue<double>(); } set { this[nameof(StartStretchRatio)].SetValue<double>(value); } }
        public double MaxStretchScale { get { return this[nameof(MaxStretchScale)].GetValue<double>(); } set { this[nameof(MaxStretchScale)].SetValue<double>(value); } }
        public Vector EffectorLocation { get { return this[nameof(EffectorLocation)].As<Vector>(); } set { this["EffectorLocation"] = value; } }
        public BoneSocketTarget EffectorTarget { get { return this[nameof(EffectorTarget)].As<BoneSocketTarget>(); } set { this["EffectorTarget"] = value; } }
    ...
    public class IKFootPelvisPullDownSolver : Object
    {
        ...
        public double PelvisAdjustmentInterpAlpha { get { return this[nameof(PelvisAdjustmentInterpAlpha)].GetValue<double>(); } set { this[nameof(PelvisAdjustmentInterpAlpha)].SetValue<double>(value); } }
        public double PelvisAdjustmentMaxDistance { get { return this[nameof(PelvisAdjustmentMaxDistance)].GetValue<double>(); } set { this[nameof(PelvisAdjustmentMaxDistance)].SetValue<double>(value); } }
        public double PelvisAdjustmentErrorTolerance { get { return this[nameof(PelvisAdjustmentErrorTolerance)].GetValue<double>(); } set { this[nameof(PelvisAdjustmentErrorTolerance)].SetValue<double>(value); } }
