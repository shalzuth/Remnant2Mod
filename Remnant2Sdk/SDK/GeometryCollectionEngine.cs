...
namespace SDK.Script.GeometryCollectionEngineSDK
{
    ...
    public class GeometryCollectionComponent : MeshComponent
    {
        ...
        public bool bEnableDamageFromCollision { get { return this[nameof(bEnableDamageFromCollision)].Flag; } set { this[nameof(bEnableDamageFromCollision)].Flag = value; } }
        ...
        public bool bUseRootProxyForNavigation { get { return this[nameof(bUseRootProxyForNavigation)].Flag; } set { this[nameof(bUseRootProxyForNavigation)].Flag = value; } }
        public bool bUpdateNavigationInTick { get { return this[nameof(bUpdateNavigationInTick)].Flag; } set { this[nameof(bUpdateNavigationInTick)].Flag = value; } }
        ...
        public void SetNotifyCrumblings(bool bNewNotifyCrumblings, bool bNewCrumblingEventIncludesChildren) { Invoke(nameof(SetNotifyCrumblings), bNewNotifyCrumblings, bNewCrumblingEventIncludesChildren); }
        public void SetNotifyBreaks(bool bNewNotifyBreaks) { Invoke(nameof(SetNotifyBreaks), bNewNotifyBreaks); }
        public void SetEnableDamageFromCollision(bool bValue) { Invoke(nameof(SetEnableDamageFromCollision), bValue); }
        public void SetAnchoredByTransformedBox(Box Box, Transform Transform, bool bAnchored, int MaxLevel) { Invoke(nameof(SetAnchoredByTransformedBox), Box, Transform, bAnchored, MaxLevel); }
        public void SetAnchoredByIndex(int Index, bool bAnchored) { Invoke(nameof(SetAnchoredByIndex), Index, bAnchored); }
        public void SetAnchoredByBox(Box WorldSpaceBox, bool bAnchored, int MaxLevel) { Invoke(nameof(SetAnchoredByBox), WorldSpaceBox, bAnchored, MaxLevel); }
        ...
        public int GetRootIndex() { return Invoke<int>(nameof(GetRootIndex)); }
        ...
        public Box GetLocalBounds() { return Invoke<Box>(nameof(GetLocalBounds)); }
        public int GetInitialLevel(int ItemIndex) { return Invoke<int>(nameof(GetInitialLevel), ItemIndex); }
        public Object GetDebugInfo() { return Invoke<Object>(nameof(GetDebugInfo)); }
    ...
    public class GeometryCollection : Object
    {
        ...
        public Dataflow DataflowAsset { get { return this[nameof(DataflowAsset)].As<Dataflow>(); } set { this["DataflowAsset"] = value; } }
        public Object DataflowTerminal { get { return this[nameof(DataflowTerminal)]; } set { this[nameof(DataflowTerminal)] = value; } }
