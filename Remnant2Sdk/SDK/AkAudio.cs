...
namespace SDK.Script.AkAudioSDK
{
    ...
    public class AkAudioType : Object
    {
        ...
        public int GetShortID() { return Invoke<int>(nameof(GetShortID)); }
    }
    ...
    public class AkAudioCustomVolume : Volume
    {
        public AkAudioCustomVolume(nint addr) : base(addr) { }
    ...
    public class AkGameplayStaticsGunfire : BlueprintFunctionLibrary
    {
        public AkGameplayStaticsGunfire(nint addr) : base(addr) { }
        public bool SetRTPCValueByPlayingId(AkRtpc RTPCValue, float Value, int InterpolationTimeMs, int PlayingID, Object RTPC) { return Invoke<bool>(nameof(SetRTPCValueByPlayingId), RTPCValue, Value, InterpolationTimeMs, PlayingID, RTPC); }
        public bool SetRTPCValueByGameObjectId(AkRtpc RTPCValue, float Value, int InterpolationTimeMs, long GameObjectId, Object RTPC) { return Invoke<bool>(nameof(SetRTPCValueByGameObjectId), RTPCValue, Value, InterpolationTimeMs, GameObjectId, RTPC); }
        public bool GetRTPCValueByPlayingId(AkRtpc RTPCValue, float Value, int PlayingID, Object RTPC) { return Invoke<bool>(nameof(GetRTPCValueByPlayingId), RTPCValue, Value, PlayingID, RTPC); }
        public bool GetRTPCValueByGameObjectId(AkRtpc RTPCValue, float Value, long GameObjectId, Object RTPC) { return Invoke<bool>(nameof(GetRTPCValueByGameObjectId), RTPCValue, Value, GameObjectId, RTPC); }
    }
    ...
    public class AkGroupValue : AkAudioType
    {
        ...
        public int GetGroupShortID() { return Invoke<int>(nameof(GetGroupShortID)); }
    }
    ...
    {
        public AkPS5InitializationSettings(nint addr) : base(addr) { }
        public AkCommonInitializationSettings CommonSettings { get { return this[nameof(CommonSettings)].As<AkCommonInitializationSettings>(); } set { this["CommonSettings"] = value; } }
        public AkCommunicationSettingsWithSystemInitialization CommunicationSettings { get { return this[nameof(CommunicationSettings)].As<AkCommunicationSettingsWithSystemInitialization>(); } set { this["CommunicationSettings"] = value; } }
    ...
    {
        public AkDPXInitializationSettings(nint addr) : base(addr) { }
    }
    public class AkPS5PlatformInfo : AkPlatformInfo
    {
        public AkPS5PlatformInfo(nint addr) : base(addr) { }
    }
    ...
    {
        public AkPS5AdvancedInitializationSettings(nint addr) : base(addr) { }
        public bool UseHardwareCodecLowLatencyMode { get { return this[nameof(UseHardwareCodecLowLatencyMode)].Flag; } set { this[nameof(UseHardwareCodecLowLatencyMode)].Flag = value; } }
    ...
    public class AkWinGDKAdvancedInitializationSettings : AkAdvancedInitializationSettingsWithMultiCoreRendering
    {
        ...
        public bool UseHeadMountedDisplayAudioDevice { get { return this[nameof(UseHeadMountedDisplayAudioDevice)].Flag; } set { this[nameof(UseHeadMountedDisplayAudioDevice)].Flag = value; } }
        public uint uMaxSystemAudioObjects { get { return this[nameof(uMaxSystemAudioObjects)].GetValue<uint>(); } set { this[nameof(uMaxSystemAudioObjects)].SetValue<uint>(value); } }
    }
