...
namespace SDK.Script.MeshModelingToolsSDK
{
    ...
    public class DisconnectGeometrySelectionCommand : GeometrySelectionEditCommand
    {
        public DisconnectGeometrySelectionCommand(nint addr) : base(addr) { }
    }
    public class ModifyGeometrySelectionCommand : GeometrySelectionEditCommand
    {
        public ModifyGeometrySelectionCommand(nint addr) : base(addr) { }
    }
    public class ModifyGeometrySelectionCommand_Invert : ModifyGeometrySelectionCommand
    {
        public ModifyGeometrySelectionCommand_Invert(nint addr) : base(addr) { }
    }
    public class ModifyGeometrySelectionCommand_ExpandToConnected : ModifyGeometrySelectionCommand
    {
        public ModifyGeometrySelectionCommand_ExpandToConnected(nint addr) : base(addr) { }
    }
    public class ModifyGeometrySelectionCommand_InvertConnected : ModifyGeometrySelectionCommand
    {
        public ModifyGeometrySelectionCommand_InvertConnected(nint addr) : base(addr) { }
    }
    public class ModifyGeometrySelectionCommand_Expand : ModifyGeometrySelectionCommand
    {
        public ModifyGeometrySelectionCommand_Expand(nint addr) : base(addr) { }
    }
    public class ModifyGeometrySelectionCommand_Contract : ModifyGeometrySelectionCommand
    {
        public ModifyGeometrySelectionCommand_Contract(nint addr) : base(addr) { }
    }
    public class RetriangulateGeometrySelectionCommand : GeometrySelectionEditCommand
    {
        public RetriangulateGeometrySelectionCommand(nint addr) : base(addr) { }
    }
    ...
    public class EditMeshPolygonsToolBuilder : SingleTargetWithSelectionToolBuilder
    {
    ...
    public class EditMeshPolygonsTool : SingleTargetWithSelectionTool
    {
    ...
    public class GroupEdgeInsertionProperties : InteractiveToolPropertySet
    {
        ...
        public bool bContinuousInsertion { get { return this[nameof(bContinuousInsertion)].Flag; } set { this[nameof(bContinuousInsertion)].Flag = value; } }
    ...
    public class UVProjectionToolBuilder : SingleTargetWithSelectionToolBuilder
    {
    ...
    public class UVProjectionToolProperties : InteractiveToolPropertySet
    {
        ...
        public bool bProportionalDimensions { get { return this[nameof(bProportionalDimensions)].Flag; } set { this[nameof(bProportionalDimensions)].Flag = value; } }
        ...
        public bool bSavedProportionalDimensions { get { return this[nameof(bSavedProportionalDimensions)].Flag; } set { this[nameof(bSavedProportionalDimensions)].Flag = value; } }
    ...
    public class UVProjectionTool : SingleTargetWithSelectionTool
    {
