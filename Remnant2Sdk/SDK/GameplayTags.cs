...
namespace SDK.Script.GameplayTagsSDK
{
    ...
    public class GameplayTagContainerNetSerializerConfig : NetSerializerConfig
    {
        public GameplayTagContainerNetSerializerConfig(nint addr) : base(addr) { }
    }
    public class GameplayTagNetSerializerConfig : NetSerializerConfig
    {
        public GameplayTagNetSerializerConfig(nint addr) : base(addr) { }
    }
