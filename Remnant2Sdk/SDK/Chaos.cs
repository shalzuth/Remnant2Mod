...
{
    public enum ChaosDeformableSimSpace : int
    {
        World = 0,
        ComponentXf = 1,
        bone = 2,
    ...
    public enum EProximityContactMethod : int
    {
    ...
    public class ClosestPhysicsObjectResult : Object
    {
        public ClosestPhysicsObjectResult(nint addr) : base(addr) { }
    }
