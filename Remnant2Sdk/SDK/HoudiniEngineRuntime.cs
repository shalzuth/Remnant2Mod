...
namespace SDK.Script.HoudiniEngineRuntimeSDK
{
    ...
    public class HDAComponent : HoudiniAssetComponent
    {
        public HDAComponent(nint addr) : base(addr) { }
    }
    ...
    public class HoudiniSplineComponent : SceneComponent
    {
        ...
        public void RemovePointAtIndex(int Index) { Invoke(nameof(RemovePointAtIndex), Index); }
        public void InsertPointAtIndex(Transform NewPoint, int Index) { Invoke(nameof(InsertPointAtIndex), NewPoint, Index); }
        public void AppendPoint(Transform NewPoint) { Invoke(nameof(AppendPoint), NewPoint); }
        public void AddCurvePoints(Array<Transform> Points) { Invoke(nameof(AddCurvePoints), Points); }
    }
