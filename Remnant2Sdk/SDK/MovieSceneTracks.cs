...
namespace SDK.Script.MovieSceneTracksSDK
{
    ...
    public class MovieSceneConsoleVariableTrackInterface : Interface
    {
        public MovieSceneConsoleVariableTrackInterface(nint addr) : base(addr) { }
    }
    public class MovieSceneDecomposerTestObject : Object
    {
        public MovieSceneDecomposerTestObject(nint addr) : base(addr) { }
        public float FloatProperty { get { return this[nameof(FloatProperty)].GetValue<float>(); } set { this[nameof(FloatProperty)].SetValue<float>(value); } }
    }
    public class MovieSceneTestSequence : MovieSceneSequence
    {
        public MovieSceneTestSequence(nint addr) : base(addr) { }
        public MovieScene MovieScene { get { return this[nameof(MovieScene)].As<MovieScene>(); } set { this["MovieScene"] = value; } }
        public Array<Object> BoundObjects { get { return new Array<Object>(this[nameof(BoundObjects)].Address); } }
        public Array<Guid> BindingGuids { get { return new Array<Guid>(this[nameof(BindingGuids)].Address); } }
    }
    ...
    public class MovieSceneCVarSection : MovieSceneSection
    {
        ...
        public Array<MovieSceneConsoleVariableCollection> ConsoleVariableCollections { get { return new Array<MovieSceneConsoleVariableCollection>(this[nameof(ConsoleVariableCollections)].Address); } }
    ...
    public class MovieSceneFadeSystem : MovieSceneEntitySystem
    {
        public MovieSceneFadeSystem(nint addr) : base(addr) { }
    }
    ...
    public class MovieSceneQuaternionBlenderSystem : MovieSceneBlenderSystem
    {
        public MovieSceneQuaternionBlenderSystem(nint addr) : base(addr) { }
    }
    ...
    public class MovieSceneSkeletalAnimationSystem : MovieSceneEntitySystem
    {
        public MovieSceneSkeletalAnimationSystem(nint addr) : base(addr) { }
    }
    public class MovieSceneTransformOriginInstantiatorSystem : MovieSceneEntitySystem
    {
        public MovieSceneTransformOriginInstantiatorSystem(nint addr) : base(addr) { }
    }
    ...
    public class MovieSceneHierarchicalEasingInstantiatorSystem : MovieSceneEntityInstantiatorSystem
    {
        ...
        public WeightAndEasingEvaluatorSystem EvaluatorSystem { get { return this[nameof(EvaluatorSystem)].As<WeightAndEasingEvaluatorSystem>(); } set { this["EvaluatorSystem"] = value; } }
    }
    ...
    public class MovieScene3DTransformTrack : MovieScenePropertyTrack
    {
        ...
        public Object BlenderSystemClass { get { return this[nameof(BlenderSystemClass)]; } set { this[nameof(BlenderSystemClass)] = value; } }
    }
    ...
    public class MovieSceneSkeletalAnimationComponentData : Object
    {
        public MovieSceneSkeletalAnimationComponentData(nint addr) : base(addr) { }
        public MovieSceneSkeletalAnimationSection Section { get { return this[nameof(Section)].As<MovieSceneSkeletalAnimationSection>(); } set { this["Section"] = value; } }
    }
    ...
    public class MovieSceneConsoleVariableCollection : Object
    {
        public MovieSceneConsoleVariableCollection(nint addr) : base(addr) { }
        public Object Interface { get { return this[nameof(Interface)]; } set { this[nameof(Interface)] = value; } }
        public bool bOnlyIncludeChecked { get { return this[nameof(bOnlyIncludeChecked)].Flag; } set { this[nameof(bOnlyIncludeChecked)].Flag = value; } }
    }
    ...
    public class MovieSceneSkeletalAnimationParams : Object
    {
        ...
        public float PlayRate { get { return this[nameof(PlayRate)].GetValue<float>(); } set { this[nameof(PlayRate)].SetValue<float>(value); } }
        public bool bReverse { get { return this[nameof(bReverse)].Flag; } set { this[nameof(bReverse)].Flag = value; } }
        public bool bTriggerNotifies { get { return this[nameof(bTriggerNotifies)].Flag; } set { this[nameof(bTriggerNotifies)].Flag = value; } }
        public Object SlotName { get { return this[nameof(SlotName)]; } set { this[nameof(SlotName)] = value; } }
