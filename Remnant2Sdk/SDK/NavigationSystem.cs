...
namespace SDK.Script.NavigationSystemSDK
{
    ...
    public class NavigationSystemV1 : NavigationSystemBase
    {
        ...
        public int GeometryExportTriangleCountWarningThreshold { get { return this[nameof(GeometryExportTriangleCountWarningThreshold)].GetValue<int>(); } set { this[nameof(GeometryExportTriangleCountWarningThreshold)].SetValue<int>(value); } }
        ...
        public byte GetPathLength(Object WorldContextObject, Vector PathStart, Vector PathEnd, double PathLength, NavigationData NavData, Object FilterClass) { return Invoke<byte>(nameof(GetPathLength), WorldContextObject, PathStart, PathEnd, PathLength, NavData, FilterClass); }
        public byte GetPathCost(Object WorldContextObject, Vector PathStart, Vector PathEnd, double PathCost, NavigationData NavData, Object FilterClass) { return Invoke<byte>(nameof(GetPathCost), WorldContextObject, PathStart, PathEnd, PathCost, NavData, FilterClass); }
    ...
    public class NavigationPath : Object
    {
        ...
        public double GetPathLength() { return Invoke<double>(nameof(GetPathLength)); }
        public double GetPathCost() { return Invoke<double>(nameof(GetPathCost)); }
    ...
    public class NavigationTestingActor : Actor
    {
        ...
        public bool bRequireNavigableEndLocation { get { return this[nameof(bRequireNavigableEndLocation)].Flag; } set { this[nameof(bRequireNavigableEndLocation)].Flag = value; } }
        ...
        public double PathCost { get { return this[nameof(PathCost)].GetValue<double>(); } set { this[nameof(PathCost)].SetValue<double>(value); } }
    ...
    public class RecastNavMesh : NavigationData
    {
        ...
        public bool bDrawTileResolutions { get { return this[nameof(bDrawTileResolutions)].Flag; } set { this[nameof(bDrawTileResolutions)].Flag = value; } }
        ...
        public bool bDrawTileBuildTimes { get { return this[nameof(bDrawTileBuildTimes)].Flag; } set { this[nameof(bDrawTileBuildTimes)].Flag = value; } }
        public bool bDrawTileBuildTimesHeatMap { get { return this[nameof(bDrawTileBuildTimesHeatMap)].Flag; } set { this[nameof(bDrawTileBuildTimesHeatMap)].Flag = value; } }
        ...
        public NavMeshResolutionParam NavMeshResolutionParams { get { return this[nameof(NavMeshResolutionParams)].As<NavMeshResolutionParam>(); } set { this["NavMeshResolutionParams"] = value; } }
    ...
    public class NavModifierVolume : Volume
    {
        ...
        public ENavigationDataResolution NavMeshResolution { get { return (ENavigationDataResolution)this[nameof(NavMeshResolution)].GetValue<int>(); } set { this[nameof(NavMeshResolution)].SetValue<int>((int)value); } }
        public void SetAreaClass(Object NewAreaClass) { Invoke(nameof(SetAreaClass), NewAreaClass); }
    }
    ...
    public enum EHeightFieldRenderMode : int
    {
        Solid = 0,
        Walkable = 1,
    ...
    public class RecastNavMeshTileGenerationDebug : Object
    {
        ...
        public bool bGenerateDebugTileOnly { get { return this[nameof(bGenerateDebugTileOnly)].Flag; } set { this[nameof(bGenerateDebugTileOnly)].Flag = value; } }
        public bool bCollisionGeometry { get { return this[nameof(bCollisionGeometry)].Flag; } set { this[nameof(bCollisionGeometry)].Flag = value; } }
        public EHeightFieldRenderMode HeightFieldRenderMode { get { return (EHeightFieldRenderMode)this[nameof(HeightFieldRenderMode)].GetValue<int>(); } set { this[nameof(HeightFieldRenderMode)].SetValue<int>((int)value); } }
        public bool bHeightfieldFromRasterization { get { return this[nameof(bHeightfieldFromRasterization)].Flag; } set { this[nameof(bHeightfieldFromRasterization)].Flag = value; } }
        public bool bHeightfieldPostInclusionBoundsFiltering { get { return this[nameof(bHeightfieldPostInclusionBoundsFiltering)].Flag; } set { this[nameof(bHeightfieldPostInclusionBoundsFiltering)].Flag = value; } }
        public bool bHeightfieldPostHeightFiltering { get { return this[nameof(bHeightfieldPostHeightFiltering)].Flag; } set { this[nameof(bHeightfieldPostHeightFiltering)].Flag = value; } }
        public bool bHeightfieldBounds { get { return this[nameof(bHeightfieldBounds)].Flag; } set { this[nameof(bHeightfieldBounds)].Flag = value; } }
    ...
    public class NavMeshResolutionParam : Object
    {
        public NavMeshResolutionParam(nint addr) : base(addr) { }
        public float CellSize { get { return this[nameof(CellSize)].GetValue<float>(); } set { this[nameof(CellSize)].SetValue<float>(value); } }
        public float CellHeight { get { return this[nameof(CellHeight)].GetValue<float>(); } set { this[nameof(CellHeight)].SetValue<float>(value); } }
    }
}
