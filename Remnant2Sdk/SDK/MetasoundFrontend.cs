...
{
    public class MetasoundParameterPack : Object
    {
        public MetasoundParameterPack(nint addr) : base(addr) { }
        public ESetParamResult SetTrigger(Object ParameterName, bool OnlyIfExists) { return Invoke<ESetParamResult>(nameof(SetTrigger), ParameterName, OnlyIfExists); }
        public ESetParamResult SetString(Object ParameterName, Object InValue, bool OnlyIfExists) { return Invoke<ESetParamResult>(nameof(SetString), ParameterName, InValue, OnlyIfExists); }
        public ESetParamResult SetInt(Object ParameterName, int InValue, bool OnlyIfExists) { return Invoke<ESetParamResult>(nameof(SetInt), ParameterName, InValue, OnlyIfExists); }
        public ESetParamResult SetFloat(Object ParameterName, float InValue, bool OnlyIfExists) { return Invoke<ESetParamResult>(nameof(SetFloat), ParameterName, InValue, OnlyIfExists); }
        public ESetParamResult SetBool(Object ParameterName, bool InValue, bool OnlyIfExists) { return Invoke<ESetParamResult>(nameof(SetBool), ParameterName, InValue, OnlyIfExists); }
        public MetasoundParameterPack MakeMetasoundParameterPack() { return Invoke<MetasoundParameterPack>(nameof(MakeMetasoundParameterPack)); }
        public bool HasTrigger(Object ParameterName) { return Invoke<bool>(nameof(HasTrigger), ParameterName); }
        public bool HasString(Object ParameterName) { return Invoke<bool>(nameof(HasString), ParameterName); }
        public bool HasInt(Object ParameterName) { return Invoke<bool>(nameof(HasInt), ParameterName); }
        public bool HasFloat(Object ParameterName) { return Invoke<bool>(nameof(HasFloat), ParameterName); }
        public bool HasBool(Object ParameterName) { return Invoke<bool>(nameof(HasBool), ParameterName); }
        public bool GetTrigger(Object ParameterName, ESetParamResult Result) { return Invoke<bool>(nameof(GetTrigger), ParameterName, Result); }
        public Object GetString(Object ParameterName, ESetParamResult Result) { return Invoke<Object>(nameof(GetString), ParameterName, Result); }
        public int GetInt(Object ParameterName, ESetParamResult Result) { return Invoke<int>(nameof(GetInt), ParameterName, Result); }
        public float GetFloat(Object ParameterName, ESetParamResult Result) { return Invoke<float>(nameof(GetFloat), ParameterName, Result); }
        public bool GetBool(Object ParameterName, ESetParamResult Result) { return Invoke<bool>(nameof(GetBool), ParameterName, Result); }
    }
    public enum ESetParamResult : int
    {
        Succeeded = 0,
        Failed = 1,
