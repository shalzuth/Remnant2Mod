...
namespace SDK.Script.CoreUObjectSDK
{
    ...
    {
        public Ray(nint addr) : base(addr) { }
        public Vector Origin { get { return this[nameof(Origin)].As<Vector>(); } set { this["Origin"] = value; } }
        public Vector Direction { get { return this[nameof(Direction)].As<Vector>(); } set { this["Direction"] = value; } }
    }
    public class Ray3d : Object
    {
        public Ray3d(nint addr) : base(addr) { }
        public Vector3d Origin { get { return this[nameof(Origin)].As<Vector3d>(); } set { this["Origin"] = value; } }
        public Vector3d Direction { get { return this[nameof(Direction)].As<Vector3d>(); } set { this["Direction"] = value; } }
    }
    public class Ray3f : Object
    {
        public Ray3f(nint addr) : base(addr) { }
        public Vector3f Origin { get { return this[nameof(Origin)].As<Vector3f>(); } set { this["Origin"] = value; } }
        public Vector3f Direction { get { return this[nameof(Direction)].As<Vector3f>(); } set { this["Direction"] = value; } }
    }
    ...
    {
        public Sphere(nint addr) : base(addr) { }
        public Vector Center { get { return this[nameof(Center)].As<Vector>(); } set { this["Center"] = value; } }
        public double W { get { return this[nameof(W)].GetValue<double>(); } set { this[nameof(W)].SetValue<double>(value); } }
    }
    public class Sphere3d : Object
    {
        public Sphere3d(nint addr) : base(addr) { }
        public Vector3d Center { get { return this[nameof(Center)].As<Vector3d>(); } set { this["Center"] = value; } }
        public double W { get { return this[nameof(W)].GetValue<double>(); } set { this[nameof(W)].SetValue<double>(value); } }
    }
    public class Sphere3f : Object
    {
        public Sphere3f(nint addr) : base(addr) { }
    ...
    public enum EInputDeviceTriggerMask : int
    {
        None = 0,
        Left = 1,
        Right = 2,
