...
namespace SDK.Script.SynthesisSDK
{
    ...
    public class SubmixEffectStereoToQuadPreset : SoundEffectSubmixPreset
    {
        public SubmixEffectStereoToQuadPreset(nint addr) : base(addr) { }
        public SubmixEffectStereoToQuadSettings Settings { get { return this[nameof(Settings)].As<SubmixEffectStereoToQuadSettings>(); } set { this["Settings"] = value; } }
        public void SetSettings(SubmixEffectStereoToQuadSettings InSettings) { Invoke(nameof(SetSettings), InSettings); }
    }
    ...
    public class SubmixEffectStereoToQuadSettings : Object
    {
        public SubmixEffectStereoToQuadSettings(nint addr) : base(addr) { }
        public bool bFlipChannels { get { return this[nameof(bFlipChannels)].Flag; } set { this[nameof(bFlipChannels)].Flag = value; } }
        public float RearChannelGain { get { return this[nameof(RearChannelGain)].GetValue<float>(); } set { this[nameof(RearChannelGain)].SetValue<float>(value); } }
    }
