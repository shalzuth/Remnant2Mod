...
namespace SDK.Script.MediaCompositingSDK
{
    ...
    public class MovieSceneMediaSection : MovieSceneSection
    {
        ...
        public MediaSource MediaSource { get { return this[nameof(MediaSource)].As<MediaSource>(); } set { this["MediaSource"] = value; } }
        public int MediaSourceProxyIndex { get { return this[nameof(MediaSourceProxyIndex)].GetValue<int>(); } set { this[nameof(MediaSourceProxyIndex)].SetValue<int>(value); } }
        ...
        public int TextureIndex { get { return this[nameof(TextureIndex)].GetValue<int>(); } set { this[nameof(TextureIndex)].SetValue<int>(value); } }
        ...
        public MovieSceneObjectBindingID MediaSourceProxyBindingID { get { return this[nameof(MediaSourceProxyBindingID)].As<MovieSceneObjectBindingID>(); } set { this["MediaSourceProxyBindingID"] = value; } }
    }
    ...
    public class MovieSceneMediaSectionParams : Object
    {
        ...
        public MediaSoundComponent MediaSoundComponent { get { return this[nameof(MediaSoundComponent)].As<MediaSoundComponent>(); } set { this["MediaSoundComponent"] = value; } }
        public MediaSource MediaSource { get { return this[nameof(MediaSource)].As<MediaSource>(); } set { this["MediaSource"] = value; } }
        public MovieSceneObjectBindingID MediaSourceProxy { get { return this[nameof(MediaSourceProxy)].As<MovieSceneObjectBindingID>(); } set { this["MediaSourceProxy"] = value; } }
        public int MediaSourceProxyIndex { get { return this[nameof(MediaSourceProxyIndex)].GetValue<int>(); } set { this[nameof(MediaSourceProxyIndex)].SetValue<int>(value); } }
        public MediaTexture MediaTexture { get { return this[nameof(MediaTexture)].As<MediaTexture>(); } set { this["MediaTexture"] = value; } }
        ...
        public bool bLooping { get { return this[nameof(bLooping)].Flag; } set { this[nameof(bLooping)].Flag = value; } }
        public FrameNumber StartFrameOffset { get { return this[nameof(StartFrameOffset)].As<FrameNumber>(); } set { this["StartFrameOffset"] = value; } }
        public MovieSceneFloatChannel ProxyTextureBlend { get { return this[nameof(ProxyTextureBlend)].As<MovieSceneFloatChannel>(); } set { this["ProxyTextureBlend"] = value; } }
    }
    public class MovieSceneMediaSectionTemplate : MovieSceneEvalTemplate
    {
        ...
        public MovieSceneMediaSection MediaSection { get { return this[nameof(MediaSection)].As<MovieSceneMediaSection>(); } set { this["MediaSection"] = value; } }
    }
}
